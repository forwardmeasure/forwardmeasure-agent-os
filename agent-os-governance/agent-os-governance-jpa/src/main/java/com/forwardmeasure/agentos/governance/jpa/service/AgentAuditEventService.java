...
public interface AgentAuditEventService extends AbstractBaseService<AgentAuditEventRecord, Long> {

  Page<AgentAuditEventRecord> findByAgentId(UUID agentId, int offset, int limit);
}
